...
The id is generated by generating a random number between 0 and 1, converting it to base 36, and taking the 10 characters after the decimal. While I am not checking if the room code is already in use, the chance of a collision is 1 in 130 quadrillion.
